head>
    ...
    <meta name="X-Csrf-Token" content="74cd31b74f99b53a809c558cc30b2bb2"/>
    ...
    <meta property="og:title" content="Submission #17467668 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dbe70af298559e75ef07fa77b62a97f9f621fc4b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17467668 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='74cd31b74f99b53a809c558cc30b2bb2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F35%2Fsubmission%2F17467668">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='74cd31b74f99b53a809c558cc30b2bb2'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/35">Problems</a></li>
        <li><a
                                        href="/contest/35/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/35/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/35/status">Status</a></li>
        <li><a
                                        href="/contest/35/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/35/room/1">Room</a></li>
        <li><a
                                        href="/contest/35/standings">Standings</a></li>
        <li><a
                                        href="/contest/35/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Fire Again" href="/contest/35/problem/C">35C</a>
...
#define S second
using namespace std;
vector< vector<int> >v(2001,vector<int>(2001,4001));
int n,m;
int main()
{
...
for(int i=0;i<n;i++)
{
  for(int j=0;j<m;j++)
  {
    for(int m=0;m<k;m++)
    {
      v[i][j]=min(v[i][j],abs(p[m].F-i)+abs(p[m].S-j));
    }
    if(v[i][j]>ans)
    {
      ans=v[i][j];
