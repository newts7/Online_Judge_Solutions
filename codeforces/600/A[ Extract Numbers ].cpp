head>
    ...
    <meta name="X-Csrf-Token" content="e5f0dc89b110a71a2c0f4f21f21cc631"/>
    ...
    <meta property="og:title" content="Submission #16632359 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="9d565a7528a0131bfd00fe497cfa20073d01ce29"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16632359 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e5f0dc89b110a71a2c0f4f21f21cc631'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F600%2Fsubmission%2F16632359">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e5f0dc89b110a71a2c0f4f21f21cc631'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/600">Problems</a></li>
        <li><a
                                        href="/contest/600/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/600/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/600/status">Status</a></li>
        <li><a
                                        href="/contest/600/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/600/standings">Standings</a></li>
        <li><a
                                        href="/contest/600/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="A - Extract Numbers" href="/contest/600/problem/A">600A</a>
...
bool lead_zero(string &x)
{
  ...
  {
      if(x[i]!=&#39;0&#39;)
      check=false,k.push_back(x[i]);
      else
      if(!check)
      k.push_back(s[i]);

  }
  return k.size()==x.size();
}
int main(){
