head>
    ...
    <meta name="X-Csrf-Token" content="a7cc9139c61014d3877440262d624649"/>
    ...
    <meta property="og:title" content="Submission #16818927 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="def9326d8a37236f323a49ba82dc8a2af751bc5a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16818927 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a7cc9139c61014d3877440262d624649'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F653%2Fsubmission%2F16818927">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a7cc9139c61014d3877440262d624649'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/653">Problems</a></li>
        <li><a
                                        href="/contest/653/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/653/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/653/status">Status</a></li>
        <li><a
                                        href="/contest/653/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/653/room/1">Room</a></li>
        <li><a
                                        href="/contest/653/standings">Standings</a></li>
        <li><a
                                        href="/contest/653/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="B - Bear and Compressing" href="/contest/653/problem/B">653B</a>
...
if(n==2)
{
  ...
  for(int j=0;j<6;j++)
  {
    ...
    while(temp.size()>1)
    {
      if(m.find(junk)==m.end())
      break;
      else
      {
        temp=m[junk]+temp.substr(2,n-2);
        junk=temp.substr(0,2);
      }
    }
    if(temp=="a")
    count++;
