head>
    ...
    <meta name="X-Csrf-Token" content="91d64a4b7df7010a218ea6d7636fc486"/>
    ...
    <meta property="og:title" content="Submission #17903976 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="aa888eed7726e0168445c922e352c1d6d5505da9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17903976 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='91d64a4b7df7010a218ea6d7636fc486'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F131%2Fsubmission%2F17903976">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='91d64a4b7df7010a218ea6d7636fc486'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - The World is a Theatre" href="/contest/131/problem/C">131C</a>
...
for(long long i=1;i<=m;i++)
{
    ...
    if(x<=n&&x>=4)
    {
      res+=(triangle[m+1][i]*triangle[n+1][x]);
  //    cout<<res<<" "<<triangle[m+1][i]<<" "<<triangle[n+1][x]<<endl;
    }
}
