head>
    ...
    <meta name="X-Csrf-Token" content="9b046b3dc6f33018919835b8f22fd64a"/>
    ...
    <meta property="og:title" content="Submission #23543591 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="0c03406339f52c31304760d65cfcf07434f8c362"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #23543591 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9b046b3dc6f33018919835b8f22fd64a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F510%2Fsubmission%2F23543591">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9b046b3dc6f33018919835b8f22fd64a'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Fox And Names" href="/contest/510/problem/C">510C</a>
...
void topologicalsort( )
{
  tr(exist,it)
  {
    ...
    if(visited.find(it->first)==visited.end()&&(indegree.find(it->first)==indegree.end()||indegree[it->first]==0))
    {
//cout<<it->first<<endl;
              tr(g[it->first],ir)
              {
...
map<char,bool>temp;
map<char,bool>check_cycle_visited;
map<char,bool>recstack;
bool cycle=false;

void check_cycle_utill(char s)
{
    check_cycle_visited[s]=true;
    recstack[s]=true;

    tr(g[s],it)
    {
      if(check_cycle_visited.find(*it)==check_cycle_visited.end())
      {
        check_cycle_utill(*it);
      }
      else
      if(recstack[*it]==true)
      {
...
void check_cycle()
{
  for(char i=&#39;a&#39;;i<=&#39;z&#39;;i++)
  {
    ...
    if(g.find(i)!=g.end()&&check_cycle_visited.find(i)==check_cycle_visited.end())
    {
      check_cycle_utill(i);
    }
  }
...
{      count++;continue; }
      ...
      {
        if(used.find(mp(v[j][k],v[i][k]))!=used.end())
        {
          cout<<"Impossible";
          return 0;
        }

        if(used.find(mp(v[i][k],v[j][k]))!=used.end())
        {
...
//cout<<v[i][k]<<" "<<v[j][k]<<endl;
    ...
    //cout<<count<<endl;
    if(count==v[j].size()&&v[i].size()>v[j].size())
    {
      cout<<"Impossible";
      return 0;
    }
