head>
    ...
    <meta name="X-Csrf-Token" content="a96954165b44f4d395cfdc1c9fbd1ac4"/>
    ...
    <meta property="og:title" content="Submission #23785663 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="1536fa85ac4505a7f41bc3905516abab555eefc1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #23785663 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a96954165b44f4d395cfdc1c9fbd1ac4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F714%2Fsubmission%2F23785663">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a96954165b44f4d395cfdc1c9fbd1ac4'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/714">Problems</a></li>
        <li><a
                                        href="/contest/714/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/714/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/714/status">Status</a></li>
        <li><a
                                        href="/contest/714/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/714/room/1">Room</a></li>
        <li><a
                                        href="/contest/714/standings">Standings</a></li>
        <li><a
                                        href="/contest/714/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Sonya and Queries" href="/contest/714/problem/C">714C</a>
...
while(q--)
{
	...
	{	
		string b="";
		while(b.size()+temp.size()<18)b.pb(&#39;0&#39;);
		b+=temp;
		cout<<m[b]<<endl;
	}
	if(c==&#39;+&#39;)
