head>
    ...
    <meta name="X-Csrf-Token" content="d21951d5495e484527a1ad9c4291efc9"/>
    ...
    <meta property="og:title" content="Submission #17162167 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="2fda2e9be3b13e383d8eae6e3b99eb833f89f54c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17162167 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d21951d5495e484527a1ad9c4291efc9'>&nbsp;</span>
...
<a href="/memsql2014"><img src="http://assets.codeforces.com/images/memsql_logo_small.png"/></a> <span style="position:relative;bottom:20px;left:5px;font-family:Arial;">Start[c]UP 2.0</span>
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F452%2Fsubmission%2F17162167">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d21951d5495e484527a1ad9c4291efc9'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="A - Eevee" href="/contest/452/problem/A">452A</a>
...
continue;
  ...
  int temp=0;
  for(int j=0;j<s.size()&&j<v[i].size();j++)
  if(s[j]==v[i][j]&&s[j]!=&#39;.&#39;)
  temp++;
  if(temp==count&&v[i].size()==s.size())
  {
    cout<<v[i];
    break;
  }
