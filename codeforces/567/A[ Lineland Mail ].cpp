head>
    ...
    <meta name="X-Csrf-Token" content="b5ca5d96e291b9b121ac9ef5f3936729"/>
    ...
    <meta property="og:title" content="Submission #21665600 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="6e9374af59b4779e9598186a7c89863250b9c7aa"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #21665600 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b5ca5d96e291b9b121ac9ef5f3936729'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F567%2Fsubmission%2F21665600">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b5ca5d96e291b9b121ac9ef5f3936729'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/567">Problems</a></li>
        <li><a
                                        href="/contest/567/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/567/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/567/status">Status</a></li>
        <li><a
                                        href="/contest/567/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/567/room/1">Room</a></li>
        <li><a
                                        href="/contest/567/standings">Standings</a></li>
        <li><a
                                        href="/contest/567/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="A - Lineland Mail" href="/contest/567/problem/A">567A</a>
...
for(int i=0;i<n;i++)
{
  long long index=v[i].S;
  if(i==0)
  {
    ans[index].F=abs(v[i+1].F-v[i].F);
    ans[index].S=abs(v[n-1].F-v[i].F);
   ...
   if(i==n-1)
   {
     ...
     ans[index].F=abs(v[i].F-v[i-1].F);
     ans[index].S=abs(v[i].F-v[0].F);
     continue;
   }

   ans[index].F=min(abs(v[i].F-v[i-1].F),abs(v[i].F-v[i+1].F));
   ans[index].S=max(abs(v[i].F-v[0].F),abs(v[i].F-v[n-1].F));
