head>
    ...
    <meta name="X-Csrf-Token" content="0f966e19673b531e94e07e95ed409bb1"/>
    ...
    <meta property="og:title" content="Submission #16687987 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dffef02af5b1aa7d5d195d17c46eb0c181120a40"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16687987 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0f966e19673b531e94e07e95ed409bb1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F400%2Fsubmission%2F16687987">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0f966e19673b531e94e07e95ed409bb1'/>
...
for(int i=0;i<12;i++)
if(a[i]==&#39;X&#39;)
{ans.push_back(mp(1,12));break;}

for(int i=0;i<6;i++)
if(a[i]==a[i+6]&&a[i]==&#39;X&#39;)
{ans.push_back(mp(2,6));break;}

for(int i=0;i<4;i++)
if(a[i]==a[i+4]&&a[i]==&#39;X&#39;&&a[i+4]==a[i+8])
{ans.push_back(mp(3,4));break;}

for(int i=0;i<3;i++)
if(a[i]==a[i+3]&&a[i]==&#39;X&#39;&&a[i+3]==a[i+6]&&a[i+6]==a[i+9])
{ans.push_back(mp(4,3));break;}


for(int i=0;i<2;i++)
if(a[i]==a[i+2]&&a[i]==&#39;X&#39;&&a[i+2]==a[i+4]&&a[i+6]==a[i+4]&&a[i+6]==a[i+8]&&a[i+8]==a[i+10])
{ans.push_back(mp(6,2));break;}
