head>
    ...
    <meta name="X-Csrf-Token" content="f133ea150c02fd7bc7364772ce34504a"/>
    ...
    <meta property="og:title" content="Submission #16634527 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f7467a66da54c951c088f21a52ff578882454b52"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16634527 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f133ea150c02fd7bc7364772ce34504a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F632%2Fsubmission%2F16634527">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f133ea150c02fd7bc7364772ce34504a'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/632">Problems</a></li>
        <li><a
                                        href="/contest/632/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/632/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/632/status">Status</a></li>
        <li><a
                                        href="/contest/632/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/632/standings">Standings</a></li>
        <li><a
                                        href="/contest/632/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="B - Alice, Bob, Two Teams" href="/contest/632/problem/B">632B</a>
...
for(long long  i=0;i<n;i++)
{
  ...
  bob+=v[i];
  if(alice-bob>diff)
  prefix=alice-bob,diff=alice-bob,posp=i;
}
diff=-1,alice=0,bob=0;
for(long long i=n-1;i>=0;i--)
{
    ...
    bob+=v[i];
    if(alice-bob>diff)
    suffix=alice-bob,diff=alice-bob,suffp=i;
}
