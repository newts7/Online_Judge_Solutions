head>
    ...
    <meta name="X-Csrf-Token" content="0187b9572af6dd9386f2fbd6b0497db1"/>
    ...
    <meta property="og:title" content="Submission #19925631 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="968a022f81f43a1472353e36ccae32fe01d9fa04"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19925631 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0187b9572af6dd9386f2fbd6b0497db1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F558%2Fsubmission%2F19925631">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0187b9572af6dd9386f2fbd6b0497db1'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/558">Problems</a></li>
        <li><a
                                        href="/contest/558/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/558/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/558/status">Status</a></li>
        <li><a
                                        href="/contest/558/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/558/room/1">Room</a></li>
        <li><a
                                        href="/contest/558/standings">Standings</a></li>
        <li><a
                                        href="/contest/558/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Amr and Chemistry" href="/contest/558/problem/C">558C</a>
...
long long n,x;
cin>>n;
vector<long long>visited(100010);
vector<long long>count(100010);
vector<long long>steps(100010);
long long k;
for(int i=1;i<=n;i++)
{
  cin>>x;
...
while(!q.empty())
{
  long long x=q.front().F,y=q.front().S;
q.pop();
  if(x>100010)
  continue;
  if(visited[x]==i)
