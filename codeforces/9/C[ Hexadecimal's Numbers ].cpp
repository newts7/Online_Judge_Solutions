head>
    ...
    <meta name="X-Csrf-Token" content="52fdfadd81da52c9cf4a2c59bd371d49"/>
    ...
    <meta property="og:title" content="Submission #16717964 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="de5c6f9549a1c174af75c7f27c88a9b942209a85"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16717964 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='52fdfadd81da52c9cf4a2c59bd371d49'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F9%2Fsubmission%2F16717964">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='52fdfadd81da52c9cf4a2c59bd371d49'/>
...
{
  temp=1000000000*a+100000000*b+10000000*c+1000000*d+100000*e+10000*f+1000*g+100*h+10*i+j;
if(temp!=0)
  s.insert(temp);
}
