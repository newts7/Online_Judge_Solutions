head>
    ...
    <meta name="X-Csrf-Token" content="a15e8cfd1d43c6af79a345e5c480afc1"/>
    ...
    <meta property="og:title" content="Submission #19518075 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="09d5af7fcdc6aa9212997492e63e50ebacaafbef"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19518075 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a15e8cfd1d43c6af79a345e5c480afc1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F702%2Fsubmission%2F19518075">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a15e8cfd1d43c6af79a345e5c480afc1'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/702">Problems</a></li>
        <li><a
                                        href="/contest/702/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/702/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/702/status">Status</a></li>
        <li><a
                                        href="/contest/702/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/702/standings">Standings</a></li>
        <li><a
                                        href="/contest/702/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Cellular Network" href="/contest/702/problem/C">702C</a>
    ...
    <td>2016-07-30 16:20:47</td>
    <td>2016-07-30 22:08:06</td>
    <td>
...
vector< pair<long long ,long long> >ans(n+m);
long long x;
for(int i=0;i<n;i++)
{
  cin>>x;
...
long long check=-10000000000000007;
...
for(int i=0;i<n+m;i++)
{
  ...
  //  cout<<ans[i].F<<" "<<ans[i].S<<endl;
    res=max(res,min(ans[i].F,ans[i].S));
  }
}
