head>
    ...
    <meta name="X-Csrf-Token" content="ebdcccb8e659e3dcfdca29a23afe64e8"/>
    ...
    <meta property="og:title" content="Submission #15858619 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="50296e7201ea999057e0cc334c082268062f21b5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15858619 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ebdcccb8e659e3dcfdca29a23afe64e8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F625%2Fsubmission%2F15858619">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ebdcccb8e659e3dcfdca29a23afe64e8'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/625">Problems</a></li>
        <li><a
                                        href="/contest/625/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/625/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/625/status">Status</a></li>
        <li><a
                                        href="/contest/625/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/625/room/1">Room</a></li>
        <li><a
                                        href="/contest/625/standings">Standings</a></li>
        <li><a
                                        href="/contest/625/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Pupil newts" class="rated-user user-green">newts</a>    </td>
    <td>
        <a title="B - War of the Corporations" href="/contest/625/problem/B">625B</a>
         - <span title="problem revision">32</span>
    </td>
    <td>
    GNU C++
    </td>
    ...
    <td>2016-02-07 12:32:01</td>
    <td>2016-02-07 14:19:47</td>
    <td>
...
for(long long i=0;i<a.size();i++)
{
    if(a[i]==b[0])
    {
        long long k=0;
        long long m=i;
        for(long long j=0;j<b.size()&&m<a.size();m++,j++,k++)
            if(a[m]!=b[j])
            break;
