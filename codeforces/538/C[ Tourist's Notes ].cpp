head>
    ...
    <meta name="X-Csrf-Token" content="99e66d60db8f18ddb94b6c15ced17650"/>
    ...
    <meta property="og:title" content="Submission #19740207 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="18f7363c602e7c44ebeb29022cfa1ff3da3a5f49"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19740207 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='99e66d60db8f18ddb94b6c15ced17650'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F538%2Fsubmission%2F19740207">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='99e66d60db8f18ddb94b6c15ced17650'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/538">Problems</a></li>
        <li><a
                                        href="/contest/538/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/538/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/538/status">Status</a></li>
        <li><a
                                        href="/contest/538/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/538/room/1">Room</a></li>
        <li><a
                                        href="/contest/538/standings">Standings</a></li>
        <li><a
                                        href="/contest/538/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Tourist's Notes" href="/contest/538/problem/C">538C</a>
...
for(int i=0;i<m;i++)
{
  ...
  if(i!=0)
  {
    if(v[i].F-v[i-1].F<abs(v[i].S-v[i-1].S))
    {
      cout<<"IMPOSSIBLE";
  //    cout<<endl;
  //    cout<<i;
...
for(int i=1;i<m;i++)
{
  ...
  {
    temp=v[i].S;
    temp+=(v[i].F-(v[i-1].F+v[i].S-v[i-1].S))/2;
  }
  else
  {
    temp=v[i-1].S;
    temp+=(v[i].F-(v[i-1].F+v[i-1].S-v[i].S))/2;
  }
  ans=max(ans,temp);
//  cout<<ans;
}
ans=max(ans,v[m-1].S+n-v[m-1].F);
cout<<ans;
  return 0;
}
