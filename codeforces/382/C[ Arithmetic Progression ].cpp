head>
    ...
    <meta name="X-Csrf-Token" content="5ad9f63b246bc7cb921f8132e49adabf"/>
    ...
    <meta property="og:title" content="Submission #15957425 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a79dde0569d858cf462be9bdda9579378993912e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15957425 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5ad9f63b246bc7cb921f8132e49adabf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F382%2Fsubmission%2F15957425">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5ad9f63b246bc7cb921f8132e49adabf'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/382">Problems</a></li>
        <li><a
                                        href="/contest/382/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/382/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/382/status">Status</a></li>
        <li><a
                                        href="/contest/382/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/382/room/1">Room</a></li>
        <li><a
                                        href="/contest/382/standings">Standings</a></li>
        <li><a
                                        href="/contest/382/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Arithmetic Progression" href="/contest/382/problem/C">382C</a>
    ...
    <pre class="prettyprint lang-cpp program-source" style="padding: 0.5em;">#include <iostream>
#include <algorithm>
using namespace std;
