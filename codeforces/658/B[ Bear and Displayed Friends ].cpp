head>
    ...
    <meta name="X-Csrf-Token" content="78f10bd09cd52f8efcc063c09e0324a9"/>
    ...
    <meta property="og:title" content="Submission #16999189 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f602180fa984a8e7fc387a79b5e755198c4574a4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16999189 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='78f10bd09cd52f8efcc063c09e0324a9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    <div style="float:left;">
            <div><a href="/vkcup2016"><img src="http://assets.codeforces.com/images/star-vkcup-2016-300.png"/></a></div>
    </div>
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F658%2Fsubmission%2F16999189">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='78f10bd09cd52f8efcc063c09e0324a9'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/658">Problems</a></li>
        <li><a
                                        href="/contest/658/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/658/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/658/status">Status</a></li>
        <li><a
                                        href="/contest/658/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/658/room/1">Room</a></li>
        <li><a
                                        href="/contest/658/standings">Standings</a></li>
        <li><a
                                        href="/contest/658/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<tr>
    ...
    <td>
            Contestant:<br/>
<a href="/profile/newts" title="Newbie newts" class="rated-user user-gray">newts</a>    </td>
    <td>
        <a title="B - Bear and Displayed Friends" href="/contest/658/problem/B">658B</a>
    ...
    <td>2016-03-28 20:32:37</td>
    <td>2016-03-28 21:48:20</td>
    <td>
...
{
  if(jarvis.size()<k)
  jarvis.push_back(rank[b]),sort(jarvis.begin(),jarvis.end());
  else
  {
      if(rank[b]<jarvis[k-1])
      jarvis[k-1]=rank[b];
...
else
{
   ...
   for(int i=0;i<k&&i<jarvis.size();i++)
   {
     if(jarvis[i]==rank[b])
     {
       cout<<"YES"<<endl;
