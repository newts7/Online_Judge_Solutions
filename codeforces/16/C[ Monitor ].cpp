head>
    ...
    <meta name="X-Csrf-Token" content="541102408e0577d2ef45332763f21c95"/>
    ...
    <meta property="og:title" content="Submission #20195591 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e8695d7cebe2b79348042ff77a422150b715f16b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #20195591 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='541102408e0577d2ef45332763f21c95'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F16%2Fsubmission%2F20195591">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='541102408e0577d2ef45332763f21c95'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/16">Problems</a></li>
        <li><a
                                        href="/contest/16/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/16/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/16/status">Status</a></li>
        <li><a
                                        href="/contest/16/standings">Standings</a></li>
        <li><a
                                        href="/contest/16/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Monitor" href="/contest/16/problem/C">16C</a>
...
for(int i=0;i<v.size();i++)
{
  ...
  if(v[i].F*v[i].S>area&&v[i].F<=a&&v[i].S<=b)
  {
    area=v[i].F*v[i].S;
    l=v[i].F;
    m=v[i].S;
