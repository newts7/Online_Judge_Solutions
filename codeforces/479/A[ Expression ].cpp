head>
    ...
    <meta name="X-Csrf-Token" content="09ee44c5c24ddcb899fe92dbb84d01e9"/>
    ...
    <meta property="og:title" content="Submission #21648778 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="4eac7d678a3ddc7161f1634c3852d5d79d51d87c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #21648778 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='09ee44c5c24ddcb899fe92dbb84d01e9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F479%2Fsubmission%2F21648778">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='09ee44c5c24ddcb899fe92dbb84d01e9'/>
...
l=(a*b)+c,
m=a*(b+c);
cout<<max(p,max(q,max(r,max(s,max(l,m)))));
