head>
    ...
    <meta name="X-Csrf-Token" content="25ddcd79fe6b9605a3139fbbf3f0d674"/>
    ...
    <meta property="og:title" content="Submission #16784970 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="66b775ccba411905a1276a194293a837b4b5e801"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16784970 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='25ddcd79fe6b9605a3139fbbf3f0d674'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F31%2Fsubmission%2F16784970">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='25ddcd79fe6b9605a3139fbbf3f0d674'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/31">Problems</a></li>
        <li><a
                                        href="/contest/31/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/31/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/31/status">Status</a></li>
        <li><a
                                        href="/contest/31/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/31/room/1">Room</a></li>
        <li><a
                                        href="/contest/31/standings">Standings</a></li>
        <li><a
                                        href="/contest/31/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="A - Worms Evolution" href="/contest/31/problem/A">31A</a>
    ...
    <td>2016-03-18 18:54:07</td>
    <td>2016-03-18 18:55:28</td>
    <td>
...
cin>>n;
vector<int>v(n+1);
vector<int>lookup(2001);
for(int i=1;i<=n;i++)
cin>>v[i],lookup[v[i]]=i;

for(int i=1;i<=n;i++)
{
  for(int j=i+1;j<=n;j++)
  if(lookup[v[i]+v[j]]!=0)
  {cout<<lookup[v[i]+v[j]]<<" "<<i<<" "<<j;
  return 0;
  }
}
