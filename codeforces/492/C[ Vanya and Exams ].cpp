head>
    ...
    <meta name="X-Csrf-Token" content="933a99c3add12e8ad95d274ed1d1119e"/>
    ...
    <meta property="og:title" content="Submission #17822880 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d785d46c5893438d0c1f2b5e74891eef728b24a3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17822880 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='933a99c3add12e8ad95d274ed1d1119e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F17822880">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='933a99c3add12e8ad95d274ed1d1119e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/492">Problems</a></li>
        <li><a
                                        href="/contest/492/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/492/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/492/status">Status</a></li>
        <li><a
                                        href="/contest/492/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/492/room/1">Room</a></li>
        <li><a
                                        href="/contest/492/standings">Standings</a></li>
        <li><a
                                        href="/contest/492/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Vanya and Exams" href="/contest/492/problem/C">492C</a>
...
long long  get=n*avg-sum;
long long  res=0;
sort(v.begin(),v.end());
for(long long  i=0;i<n;i++)
{
  if((r-v[i].S)<get)
  res+=(r-v[i].S)*v[i].F,get-=(r-v[i].S);
  else
  {
    res+=(get)*v[i].F;
break;
