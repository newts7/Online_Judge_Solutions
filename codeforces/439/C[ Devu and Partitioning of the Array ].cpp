head>
    ...
    <meta name="X-Csrf-Token" content="8cc45a4d33271c151be671ae054fef22"/>
    ...
    <meta property="og:title" content="Submission #19847517 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="2dd7ccff46d86d3956b9e1b0795c3cb0b3fccac9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19847517 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8cc45a4d33271c151be671ae054fef22'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F439%2Fsubmission%2F19847517">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8cc45a4d33271c151be671ae054fef22'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Devu and Partitioning of the Array" href="/contest/439/problem/C">439C</a>
...
stack<long long>even,odd;
vector< vector<long long> >even_ans(p),odd_ans(k-p);
for(int i=0;i<n;i++)
{
  cin>>x;
  if(x%2==0)
...
if(k==p)
{
  ...
  while(!even.empty())
  {
    long long s=even.top();
    even_ans[indx%p].pb(s);
    even.pop();
    indx++;
  }
...
{  long long a,b;
  ...
  for(int i=0;i<p;i++)
  {
    cout<<even_ans[i].size()<<" ";
    for(int j=0;j<even_ans[i].size();j++)
    cout<<even_ans[i][j]<<" ";
    cout<<endl;
  }
...
{
  cout<<odd_ans[i].size()<<" ";
  for(int j=0;j<odd_ans[i].size();j++)
  cout<<odd_ans[i][j]<<" ";
  cout<<endl;
}
