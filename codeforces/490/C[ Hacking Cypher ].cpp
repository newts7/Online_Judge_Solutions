head>
    ...
    <meta name="X-Csrf-Token" content="64104f1dc4f9c9d5596004789763cfa6"/>
    ...
    <meta property="og:title" content="Submission #15920200 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dd8bf3ab93892be5cc88cfeecdd66849c2879a65"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15920200 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='64104f1dc4f9c9d5596004789763cfa6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F490%2Fsubmission%2F15920200">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='64104f1dc4f9c9d5596004789763cfa6'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Hacking Cypher" href="/contest/490/problem/C">490C</a>
...
for(long long i=0;i<n;i++)
{
   ...
   {
       prefix[i]=((10*prefix[i-1])%a+rem%a)%a;
   }
...
for(long long i=n-1,j=0;i>=0;i--,j++)
{
    ...
    {
     //   cout<<power(10,j,b)<<endl;
     suffix[i]= (((power(10,j,b)%b)*(rem%b))%b+ suffix[i+1]%b)%b;
    }
}
...
for(long long pos=0;pos<n-1;pos++)
{
    if(prefix[pos]==0&&suffix[pos+1]==0&&s[pos+1]!=&#39;0&#39;)
    {
        cout<<"YES"<<endl;
        cout<<s.substr(0,pos+1)<<endl;
        cout<<s.substr(pos+1,n-pos+1);
