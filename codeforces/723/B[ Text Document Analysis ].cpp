head>
    ...
    <meta name="X-Csrf-Token" content="d84539eabeed7b95d6cb8885b32e33d1"/>
    ...
    <meta property="og:title" content="Submission #21145262 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="eea87825e57ef4124826cfa59d869589ee9a0f19"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #21145262 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d84539eabeed7b95d6cb8885b32e33d1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F723%2Fsubmission%2F21145262">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d84539eabeed7b95d6cb8885b32e33d1'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/723">Problems</a></li>
        <li><a
                                        href="/contest/723/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/723/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/723/status">Status</a></li>
        <li><a
                                        href="/contest/723/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/723/room/1">Room</a></li>
        <li><a
                                        href="/contest/723/standings">Standings</a></li>
        <li><a
                                        href="/contest/723/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="B - Text Document Analysis" href="/contest/723/problem/B">723B</a>
    ...
    <td>2016-10-03 15:11:13</td>
    <td>2016-10-03 17:18:26</td>
    <td>
...
for(int i=0;i<n; )
{
  ...
  else
  {
    ...
    while(s[i]!=&#39;(&#39;&&i<n)
    {
      ...
      {
        if(temp.size()>0)
        ans1=max(ans1,(long long )temp.size());
        temp="";
      }
      else
      temp+=s[i];
