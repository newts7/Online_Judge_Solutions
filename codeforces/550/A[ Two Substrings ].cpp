head>
    ...
    <meta name="X-Csrf-Token" content="426df3c881677352245c200b2452f233"/>
    ...
    <meta property="og:title" content="Submission #17162983 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="c66165de3484aad7c056ba4653c2a9c00fb7adf5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17162983 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='426df3c881677352245c200b2452f233'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F17162983">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='426df3c881677352245c200b2452f233'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/550">Problems</a></li>
        <li><a
                                        href="/contest/550/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/550/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/550/status">Status</a></li>
        <li><a
                                        href="/contest/550/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/550/room/1">Room</a></li>
        <li><a
                                        href="/contest/550/standings">Standings</a></li>
        <li><a
                                        href="/contest/550/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="A - Two Substrings" href="/contest/550/problem/A">550A</a>
...
if(jarvis.size()<1||shadow.size()<1)
{
  cout<<"NO";
  return 0;
}
...
for(vector<int>::iterator it=shadow.begin();it!=shadow.end();it++)
{
bool check1,check2;
jarvis.find(*it+1)==jarvis.end()?check1=true:check1=false;
jarvis.find(*it-1)==jarvis.end()?check2=true:check2=false;
