head>
    ...
    <meta name="X-Csrf-Token" content="190c65fd6e7771ef99c6dca49956f575"/>
    ...
    <meta property="og:title" content="Submission #19399045 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="b29bd6922b8f81ccb592ddf15d023e2c7db23169"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19399045 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='190c65fd6e7771ef99c6dca49956f575'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F19399045">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='190c65fd6e7771ef99c6dca49956f575'/>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="B - Kefa and Company" href="/contest/580/problem/B">580B</a>
...
long long ans=-1,frnd=0;
for(int i=0,j=0;i<n&&j<n;i++)
{
while(v[i].F<(v[j].F+d)&&j<n)
frnd+=v[j].S,j++;
ans=max(ans,frnd);
//cout<<ans<<" "<<frnd<<endl;
frnd-=v[i].S;
