head>
    ...
    <meta name="X-Csrf-Token" content="1de615650a9e001065e13ce535a49be9"/>
    ...
    <meta property="og:title" content="Submission #20309386 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="4701360312f0fd43b151809b0c0bd3295655b397"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #20309386 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1de615650a9e001065e13ce535a49be9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F218%2Fsubmission%2F20309386">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1de615650a9e001065e13ce535a49be9'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/218">Problems</a></li>
        <li><a
                                        href="/contest/218/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/218/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/218/status">Status</a></li>
        <li><a
                                        href="/contest/218/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/218/room/1">Room</a></li>
        <li><a
                                        href="/contest/218/standings">Standings</a></li>
        <li><a
                                        href="/contest/218/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Ice Skating" href="/contest/218/problem/C">218C</a>
         - <span title="problem revision">41</span>
    </td>
    <td>
    GNU C++11
    </td>
...
void dfs(int i)
{
  visited[i]=true;
   for(int j=0;j<n;j++)
   {
     if(i==j)
     continue;
     if((v[i].F==v[j].F||v[i].S==v[j].S)&&visited[j]==false)
     dfs(j);
   }
}
int main()
