head>
    ...
    <meta name="X-Csrf-Token" content="7b3b52da9bd7e72cb854bd5ab1a5bdcf"/>
    ...
    <meta property="og:title" content="Submission #18008908 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="52a077c07df2c0988acab135fee14e5dd4300e53"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18008908 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7b3b52da9bd7e72cb854bd5ab1a5bdcf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div>
                    <a href="/enter?back=%2Fcontest%2F6%2Fsubmission%2F18008908">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7b3b52da9bd7e72cb854bd5ab1a5bdcf'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/6">Problems</a></li>
        <li><a
                                        href="/contest/6/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/6/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/6/status">Status</a></li>
        <li><a
                                        href="/contest/6/standings">Standings</a></li>
        <li><a
                                        href="/contest/6/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/newts" title="Specialist newts" class="rated-user user-cyan">newts</a>    </td>
    <td>
        <a title="C - Alice, Bob and Chocolate" href="/contest/6/problem/C">6C</a>
...
long long n;
cin>>n;
vector<long long>v(n),sum_a(n),sum_b(n);
long long sum=0;
for(long long i=0;i<n;i++)
cin>>v[i],sum+=v[i],sum_a[i]=sum;
long long alice=0;
sum=0;
for(long long i=n-1;i>=0;i--)
sum+=v[i],sum_b[i]=sum;
long long i=0;
while(sum_a[i]<=sum_b[i])
{
  alice++;
  i++;
}
